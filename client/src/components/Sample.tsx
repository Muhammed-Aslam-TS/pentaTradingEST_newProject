        ...
        <div className="flex flex-col lg:flex-row justify-center items-center py-12 mx-4 ">
          <div className="lg:w-1/2 flex flex-col justify-center items-center lg:items-start">
            ...
            <div className="w-full flex justify-center lg:justify-start">
              <button className="bg-indigo-700 text-base font-medium text-white rounded text-center py-4 px-9 mt-8 lg:mt-12 hover:bg-indigo-600 leading-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 w-full sm:w-auto">
                View All
              </button>
            </div>
          </div>
          <div
            ...
            className="lg:w-1/2 grid grid-cols-4  gap-x-12 gap-y-12 md:gap-x-12 mt-10 lg:mt-0 sm:w-auto w-full"
          >
