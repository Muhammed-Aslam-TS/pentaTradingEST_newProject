...
const BottomNavbar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 lg:top-7 bg-gray-200 z-50 w-full flex flex-wrap items-center justify-between py-5 ${
          color
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none py-2 lg:py-0 space-y-3 lg:space-y-0 lg:ml-auto">
              <li className="nav-item">
                <a
                  className="px-7  flex items-center text-xs uppercase font-medium leading-snug text-black hover:opacity-75"
                  href="#pablo"
                  onClick={() => handleOptionClick("home")}
                >
                  <span
                    className={`py-1 ${
                      selectedOption === "home" ? "border-b-2 border-black" : ""
                    }`}
                  >
                    HOME
                  </span>
              ...
              <li className="nav-item">
                <a
                  className="ps-7  flex items-center text-xs uppercase font-medium leading-snug text-black hover:opacity-75"
                  href="#pablo"
