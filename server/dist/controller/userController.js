...
const heroHelpers_1 = __importDefault(require("../helpers/heroHelpers"));
...
exports.default = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, storage_1.uploadBytes)(storageRef, (_b = req.file) === null || _b === void 0 ? void 0 : _b.buffer).then((snapshort) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    console.log('__________________________________');
                    const body = req.body;
                    yield heroHelpers_1.default.HeroImage(imageUrl, body);
    ...
    getHeroImage(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const images = yield imageModels_1.default.find({}).sort({ _id: -1 });
                res.json(images);
            }
            catch (error) {
    ...
    deleteBannerImage(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const imageId = req.query.imageId;
                console.log(imageId);
                yield imageModels_1.default.findOneAndDelete({ _id: imageId });
